...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.skullcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.skullcointools.com");
        vSeeds.emplace_back("dnsseed.skullcoinpool.org");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,25);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,50);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,25);
        base58Prefixes[EXT_PUBLIC_KEY] = {0xfa, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0xfa, 0x88, 0xAD, 0xE4};
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.skullcointools.com");
        vSeeds.emplace_back("seed-b.skullcoin.loshan.co.uk");
