...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " skullcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  skullcoin-tx [options] <hex-tx> [commands]  Update hex-encoded skullcoin transaction\n" +
            "or:     skullcoin-tx [options] -create [commands]   Create hex-encoded skullcoin transaction\n" +
            "\n";
