...
"""Verify that starting skullcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start skullcoin with -h for help text")
        ...
        self.log.info("Start skullcoin with -version for version information")
        ...
        self.log.info("Start skullcoind with -fakearg to make sure it does not start")
