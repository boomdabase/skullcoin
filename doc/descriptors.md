# Support for Output Descriptors in Skullcoin Core

Since Skullcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Skullcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Skullcoin Core wallets, a convenience function `combo` is
