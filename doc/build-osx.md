...
1. Clone the Skullcoin Core source code:
...
2.  Build Skullcoin Core:
    ...
    Configure and build the headless Skullcoin Core binaries as well as the GUI (if Qt is found).
...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/skullcoin/src
        cp skullcoind /usr/local/bin/
        cp skullcoin-cli /usr/local/bin/
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/Skullcoin"

    touch "/Users/${USER}/Library/Application Support/Skullcoin/skullcoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Skullcoin/skullcoin.conf"

The first time you run skullcoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
